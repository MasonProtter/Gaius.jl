...
#+HTML: <a href="https://github.com/MasonProtter/Gaius.jl/actions?query=workflow%3ACI"><img src="https://github.com/MasonProtter/Gaius.jl/workflows/CI/badge.svg" alt="Continuous Integration" title="Continuous Integration"></a> <a href="https://github.com/MasonProtter/Gaius.jl/actions?query=workflow%3A%22CI+%28Julia+nightly%29%22"><img src="https://github.com/MasonProtter/Gaius.jl/workflows/CI%20(Julia%20nightly)/badge.svg" alt="Continuous Integration (Julia nightly)" title="Continuous Integration (Julia nightly)"></a> <a href="https://codecov.io/gh/MasonProtter/Gaius.jl"><img src="https://codecov.io/gh/MasonProtter/Gaius.jl/branch/master/graph/badge.svg" alt="Code Coverage" title="Code Coverage"></a>
