...
Gaius.jl outperforms [[https://github.com/xianyi/OpenBLAS][OpenBLAS]] for a gigantic range of matrix sizes,
though it will eventually fall behind (i'll update this with
quantitave sizes where it falls begind).
